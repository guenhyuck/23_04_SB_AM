...
<html>
  <head>
    ...
    <script>
      const CONFIGURATION = {
        "locations": [
          {"title":"대전광역시청","address1":"대한민국 대전광역시 서구 둔산로 100","coords":{"lat":36.350690008691856,"lng":127.38487770859834},"placeId":"ChIJHy3jdmBJZTURWqpqNDVvOjc"}
        ],
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAq3dzxLVXjDuYYbkgoEC-xu7fejhiFd_c&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_locatorplus_v6_cABCDE" async defer></script>
  </body>
</html>
